...
const section = platformSections.find((item) => item.slug === "e-services")!;

export const metadata: Metadata = defaultMetadata({
  title: "الخدمات الإلكترونية في ليبيا",
  description: "روابط وشروحات للخدمات الحكومية والمصرفية والمنصات الرقمية، مع خطوات الاستخدام والمشاكل الشائعة.",
  alternates: { canonical: section.href },
  openGraph: { title: "الخدمات الإلكترونية في ليبيا", description: "روابط وشروحات للخدمات الحكومية والمصرفية والمنصات الرقمية، مع خطوات الاستخدام والمشاكل الشائعة.", url: section.href }
});

export default function SectionPage() {
  const posts = getPostsBySection("e-services");
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="max-w-3xl">
        ...
        <h1 className="mt-3 font-display text-4xl font-semibold leading-tight">الخدمات الإلكترونية في ليبيا</h1>
        <p className="mt-4 text-lg leading-8 text-muted dark:text-slate-300">روابط وشروحات للخدمات الحكومية والمصرفية والمنصات الرقمية، مع خطوات الاستخدام والمشاكل الشائعة.</p>
      </div>
