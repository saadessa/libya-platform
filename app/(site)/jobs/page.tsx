...
const section = platformSections.find((item) => item.slug === "jobs")!;

export const metadata: Metadata = defaultMetadata({
  title: "الوظائف في ليبيا",
  description: "فرص عمل منظمة حسب الجهة والمدينة والموعد النهائي مع طريقة التقديم والروابط الداخلية ذات الصلة.",
  alternates: { canonical: section.href },
  openGraph: { title: "الوظائف في ليبيا", description: "فرص عمل منظمة حسب الجهة والمدينة والموعد النهائي مع طريقة التقديم والروابط الداخلية ذات الصلة.", url: section.href }
});

export default function SectionPage() {
  const posts = getPostsBySection("jobs");
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="max-w-3xl">
        ...
        <h1 className="mt-3 font-display text-4xl font-semibold leading-tight">الوظائف في ليبيا</h1>
        <p className="mt-4 text-lg leading-8 text-muted dark:text-slate-300">فرص عمل منظمة حسب الجهة والمدينة والموعد النهائي مع طريقة التقديم والروابط الداخلية ذات الصلة.</p>
      </div>
